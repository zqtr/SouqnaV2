...
سوقنا مفتوحة المصدر بموجب رخصة [GNU AGPL-3.0](LICENSE). لك حرية الاستخدام والاستضافة الذاتية والتعديل؛ وإذا شغّلت نسخة معدّلة كخدمة عبر الشبكة، تُلزمك الرخصة بإتاحة الكود المعدّل لمستخدميها.
