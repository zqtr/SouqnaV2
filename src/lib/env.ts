...
const schema = z.object({
  ...
  SENT_TEMPLATE_CUSTOMER_CARE_ID: z.string().uuid().default('8681a1e0-70af-4960-8874-3668917bfdb6'),
  SENT_TEMPLATE_FRAUD_ALERT_ID: z.string().uuid().default('8f800498-7173-4385-b6ba-dc3947e6ba7d'),
...
export const env = parsed.success
  ...
  : {
      ...
      SENT_TEMPLATE_ACCOUNT_NOTIFICATION_ID: '8681a1e0-70af-4960-8874-3668917bfdb6',
