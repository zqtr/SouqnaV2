...
export const templatePresets: Record<TemplateId, TemplatePreset> = {
  ...
  kiosk: {
    ...
    theme: {
      ...
      sectionSpacing: 'spacious',
      commerceChrome: {
        navbar: 'navbar-command',
        footer: 'footer-support',
        sidebar: 'sidebar-category-rail',
        cart: 'cart-luxury-sheet',
        navAnnouncement: 'New drop checkout is live',
        navCtaLabel: 'Shop the drop',
        navCtaHref: '/products',
        footerHeadline: 'Launch support',
        footerText: 'Product links, policies, and WhatsApp support stay close to checkout.',
        footerShowNewsletter: true,
        sidebarLabel: 'Drop menu',
        cartLabel: 'Bag',
  ...
  lounge: {
    ...
    theme: {
      ...
      sectionSpacing: 'comfortable',
      commerceChrome: {
        navbar: 'navbar-ecommerce-2',
        footer: 'footer-commerce',
        sidebar: 'sidebar-none',
        cart: 'cart-mini-drawer',
        navAnnouncement: 'Simple checkout, clear delivery',
        navCtaLabel: 'Shop products',
        navCtaHref: '/products',
        footerHeadline: 'Checkout support',
        footerText: 'Products, policies, and contact links remain easy to reach.',
  ...
  bazaar: {
    ...
    theme: {
      ...
      commerceChrome: {
        ...
        sidebar: 'sidebar-filter-drawer',
        cart: 'cart-checkout-rail',
        navAnnouncement: 'Limited editions and seasonal drops',
        navCtaLabel: 'View catalogue',
        navCtaHref: '/products',
        footerHeadline: 'Drop directory',
        footerText: 'Collections, policies, and support links for high-intent shoppers.',
        footerShowNewsletter: true,
        sidebarLabel: 'Browse drops',
        cartLabel: 'Cart',
        cartCheckoutLabel: 'Secure checkout',
      },
    },
  ...
  vitrine: {
    ...
    theme: {
      ...
      sectionSpacing: 'spacious',
      commerceChrome: {
        navbar: 'navbar-max-command',
        footer: 'footer-max-directory',
        sidebar: 'sidebar-max-catalog',
        cart: 'cart-command-cart',
        navAnnouncement: 'Premium product suite with guided checkout',
        navCtaLabel: 'Explore suite',
        navCtaHref: '/products',
        footerHeadline: 'Product suite directory',
        footerText: 'A deeper storefront system for products, policies, support, and checkout confidence.',
        footerShowNewsletter: true,
        sidebarLabel: 'Suite menu',
        cartLabel: 'Command cart',
        cartCheckoutLabel: 'Continue checkout',
      },
    },
  ...
  monoline: {
    ...
    theme: {
      ...
      sectionSpacing: 'spacious',
      commerceChrome: {
        navbar: 'navbar-ecommerce-4',
        footer: 'footer-newsletter',
        sidebar: 'sidebar-none',
        cart: 'cart-bottom-bar',
        navAnnouncement: 'Local delivery and easy checkout',
        navCtaLabel: 'View menu',
        navCtaHref: '/products',
        footerHeadline: 'Hospitality support',
        footerText: 'Menu links, policies, and contact stay visible for repeat orders.',
        footerShowNewsletter: true,
        cartLabel: 'Cart',
        cartCheckoutLabel: 'Place order',
      },
    },
  ...
  harvest: {
    ...
    theme: {
      ...
      commerceChrome: {
        ...
        footer: 'footer-policy-grid',
        sidebar: 'sidebar-category-rail',
        cart: 'cart-luxury-sheet',
        navAnnouncement: 'Handmade catalogue with clear checkout',
        navCtaLabel: 'Browse products',
        navCtaHref: '/products',
        footerHeadline: 'Maker support',
        footerText: 'Provenance, products, policies, and support are grouped for serious buyers.',
        footerShowNewsletter: true,
  ...
  launchpad: {
    ...
    theme: {
      ...
      sectionSpacing: 'comfortable',
      commerceChrome: {
        navbar: 'navbar-search-first',
        footer: 'footer-luxury',
        sidebar: 'sidebar-account-style',
        cart: 'cart-max-summary',
        navAnnouncement: 'Digital offers, demos, and checkout in one flow',
        navCtaLabel: 'View offers',
        navCtaHref: '/products',
        footerHeadline: 'Digital store system',
        footerText: 'Offer pages, product details, policies, and support stay organized for high-value carts.',
        footerShowNewsletter: true,
        sidebarLabel: 'Offer menu',
        cartLabel: 'Summary',
        cartCheckoutLabel: 'Continue payment',
      },
    },
  ...
  frame: {
    ...
    theme: {
      ...
      themeBehaviour: 'dark',
      commerceChrome: {
        navbar: 'navbar-luxury',
        footer: 'footer-editorial',
        sidebar: 'sidebar-floating-menu',
        cart: 'cart-luxury-sheet',
        navAnnouncement: 'Gallery commerce with premium checkout',
        navCtaLabel: 'Shop work',
        navCtaHref: '/products',
        footerHeadline: 'Portfolio commerce',
        footerText: 'Artwork, product pages, policies, and direct contact stay in one refined path.',
        footerShowNewsletter: true,
        sidebarLabel: 'Gallery menu',
        cartLabel: 'Bag',
        cartCheckoutLabel: 'Checkout',
      },
    },
