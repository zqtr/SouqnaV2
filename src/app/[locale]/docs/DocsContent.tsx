...
const PLANS_TABLE = [
  {
    ...
    en: {
      ...
      price: '0 QAR',
      stores: '1 storefront',
      tpl: '10 products, 1 template, 25 orders/month',
    },
  ...
  },
  {
    ...
    en: {
      ...
      tpl: 'Unlimited products, 5 templates, 100 AI credits',
    },
  ...
  },
  {
    ...
    en: {
      ...
      tpl: 'Souqy AI, marketing apps, team, automation, advanced analytics',
    },
    ar: {
      name: 'برو +',
      price: '٣٥٠ ر.ق / شهر',
  ...
  },
  {
    ...
    en: {
      ...
      tpl: 'White-label tools, API access, bulk operations, dedicated support',
    },
    ar: {
      name: 'ماكس +',
      price: '٧٠٠ ر.ق / شهر',
    ...
    body: {
      en: (
        <>
          ...
          <p>
            You don\u2019t need a credit card to start. The Free plan gets you 1 storefront, 10
            products, 1 template, 25 checkout orders per month, and Souqna branding.
          </p>
        </>
      ),
      ar: (
