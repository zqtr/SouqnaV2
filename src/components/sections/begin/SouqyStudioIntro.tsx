...
const CREATION_TYPES: Array<{
...
}> = [
  {
    ...
    hintAr: 'Ø¹Ù„Ø§Ù…Ø§Øª ÙˆØ´Ø¹Ø§Ø±Ø§Øª ÙˆØ®Ø·ÙˆØ·',
  ...
  },
  {
    ...
    hintAr: 'Ø¥Ø·Ù„Ø§Ù‚Ø§Øª ÙˆØ¹Ø±ÙˆØ¶',
  ...
  },
  {
    ...
    hintAr: 'Ù„Ù„Ù…ØªØ¬Ø± ÙˆØ§Ù„ÙˆÙŠØ¨',
  ...
  },
  {
    ...
    hintAr: 'Ø¥Ø¹Ù„Ø§Ù†Ø§Øª Ø§Ù„Ø³ÙˆØ´Ø§Ù„',
    defaultFormat: 'instagram-post',
  },
  {
    id: 'restaurant-menu',
    ...
    hintAr: 'Ù…Ø·Ø§Ø¹Ù… ÙˆÙ…Ù‚Ø§Ù‡ÙŠ ÙˆØµØ§Ù„ÙˆÙ†Ø§Øª',
  ...
  },
  {
    ...
    icon: ShoppingBag,
    en: 'Product card',
    ar: 'Ø¨Ø·Ø§Ù‚Ø© Ù…Ù†ØªØ¬',
    hintEn: 'Catalog-led creative',
    hintAr: 'ØªØµÙ…ÙŠÙ… Ù…Ø±ØªØ¨Ø· Ø¨Ø§Ù„ÙƒØªØ§Ù„ÙˆØ¬',
  ...
  },
  {
    ...
    hintAr: 'Ù…Ù„ØµÙ‚Ø§Øª ÙˆØµÙ†Ø§Ø¯ÙŠÙ‚ ÙˆØªØºÙ„ÙŠÙ',
    defaultFormat: 'instagram-post',
  },
  {
    id: 'brand-identity',
    icon: Palette,
    en: 'Brand identity',
    ar: 'Ù‡ÙˆÙŠØ© Ø¨ØµØ±ÙŠØ©',
    hintEn: 'Full visual systems',
    hintAr: 'Ø£Ù†Ø¸Ù…Ø© Ø¨ØµØ±ÙŠØ© ÙƒØ§Ù…Ù„Ø©',
    defaultFormat: 'wide-banner',
  },
  {
    id: 'brand-kit',
    ...
    hintAr: 'Ø£Ù„ÙˆØ§Ù† ÙˆØ®Ø·ÙˆØ· ÙˆØªØ·Ø¨ÙŠÙ‚Ø§Øª',
    defaultFormat: 'wide-banner',
  },
  {
    id: 'story-promo',
    ...
    hintAr: 'Ù‚ØµØµ Ø¹Ù…ÙˆØ¯ÙŠØ© Ù„Ù„Ø³ÙˆØ´Ø§Ù„',
  ...
  },
  {
    ...
    icon: Video,
    en: 'Short video',
    ar: 'ÙÙŠØ¯ÙŠÙˆ Ù‚ØµÙŠØ±',
    hintEn: 'Motion-ready storyboards',
    hintAr: 'Ù„ÙˆØ­Ø§Øª Ø¬Ø§Ù‡Ø²Ø© Ù„Ù„Ø­Ø±ÙƒØ©',
...
const FORMAT_PRESETS: Array<{
  ...
  },
  {
    ...
    icon: PanelLeft,
    en: 'Instagram Story',
    ar: 'Ø³ØªÙˆØ±ÙŠ Ø¥Ù†Ø³ØªØºØ±Ø§Ù…',
    size: '1080x1920',
  },
  { id: 'tiktok', icon: TikTokIcon, en: 'TikTok', ar: 'ØªÙŠÙƒ ØªÙˆÙƒ', size: '1080x1920' },
  { id: 'snapchat', icon: GhostIcon, en: 'Snapchat', ar: 'Ø³Ù†Ø§Ø¨ Ø´Ø§Øª', size: '1080x1920' },
  {
    id: 'whatsapp-status',
    icon: WhatsAppIcon,
    en: 'WhatsApp Status',
    ar: 'Ø­Ø§Ù„Ø© ÙˆØ§ØªØ³Ø§Ø¨',
    size: '1080x1920',
  },
  { id: 'x-banner', icon: XIcon, en: 'X Banner', ar: 'Ø¨Ø§Ù†Ø± X', size: '1600x900' },
  { id: 'a3-print', icon: Printer, en: 'A3 Print', ar: 'Ø·Ø¨Ø§Ø¹Ø© A3', size: '297x420mm' },
  { id: 'menu-print', icon: Archive, en: 'Menu Print', ar: 'Ù…Ù†ÙŠÙˆ Ù„Ù„Ø·Ø¨Ø§Ø¹Ø©', size: 'A4' },
  {
    id: 'product-card',
    icon: ShoppingBag,
    en: 'Product Card',
  ...
  { id: 'logo-square', icon: BadgeCheck, en: 'Logo Square', ar: 'Ø´Ø¹Ø§Ø± Ù…Ø±Ø¨Ø¹', size: '1024x1024' },
  {
    id: 'wide-banner',
    icon: LayoutTemplate,
    en: 'Wide Banner',
...
const QUICK_PROMPTS = [
  {
    ...
    ar: 'ØµÙ…Ù… Ø¨ÙˆØ³ØªØ± Ø¥Ø·Ù„Ø§Ù‚ ÙØ§Ø®Ø± Ù„Ù…Ø·Ø¹Ù… Ø¨Ø±Ø¬Ø± Ø¨Ø¥Ø¶Ø§Ø¡Ø© Ø¯Ø§ÙØ¦Ø© ÙˆØ¹Ù†ÙˆØ§Ù† Ø¹Ø±Ø¨ÙŠ ÙˆØ§Ø¶Ø­.',
  },
  {
    en: 'Turn this brand into a full Instagram ad for the weekend offer.',
    ar: 'Ø­ÙˆÙ‘Ù„ Ø§Ù„Ø¨Ø±Ø§Ù†Ø¯ Ø¥Ù„Ù‰ Ø¥Ø¹Ù„Ø§Ù† Ø¥Ù†Ø³ØªØºØ±Ø§Ù… ÙƒØ§Ù…Ù„ Ù„Ø¹Ø±Ø¶ Ù†Ù‡Ø§ÙŠØ© Ø§Ù„Ø£Ø³Ø¨ÙˆØ¹.',
  },
  {
    en: 'Design a clean product card using my catalog item and Souqy colors.',
    ar: 'ØµÙ…Ù… Ø¨Ø·Ø§Ù‚Ø© Ù…Ù†ØªØ¬ Ù†Ø¸ÙŠÙØ© Ø¨Ø§Ø³ØªØ®Ø¯Ø§Ù… Ù…Ù†ØªØ¬ Ù…Ù† Ø§Ù„ÙƒØªØ§Ù„ÙˆØ¬ ÙˆØ£Ù„ÙˆØ§Ù† Ø³ÙˆÙ‚ÙŠ.',
  },
  {
    en: 'Build an elegant cafe menu that is ready for print.',
    ar: 'Ø¬Ù‡Ø² Ù…Ù†ÙŠÙˆ Ù…Ù‚Ù‡Ù‰ Ø£Ù†ÙŠÙ‚ ÙˆØ¬Ø§Ù‡Ø² Ù„Ù„Ø·Ø¨Ø§Ø¹Ø©.',
  },
];
...
export function SouqyStudioIntro({ locale }: Props) {
  ...
  async function ensureProject(): Promise<SouqyStudioProject | null> {
    ...
    const cleanName = isRtl ? 'Ø¬Ù„Ø³Ø© Ø³ÙˆÙ‚ÙŠ Ø³ØªÙˆØ¯ÙŠÙˆ' : 'Souqy Studio Session';
  ...
  async function generateAsset() {
    ...
    try {
      ...
      setStatusMessage(
        isRtl
          ? `ØªÙ… Ø¥Ù†Ø´Ø§Ø¡ ${result.assets.length} Ø£ØµÙ„.`
...
function labelForAsset(asset: SouqyStudioAsset, isRtl: boolean): string {
  ...
  return isRtl ? 'Ø£ØµÙ„ Ø³ÙˆÙ‚ÙŠ' : 'Souqy asset';
}
...
function studioCopy(isRtl: boolean) {
  return isRtl
    ? {
        aiMemory: 'Ø°Ø§ÙƒØ±Ø© Ø§Ù„Ø°ÙƒØ§Ø¡',
        aiSlogan: 'Ø´Ø¹Ø§Ø± Ø°ÙƒÙŠ',
        attach: 'Ø¥Ø±ÙØ§Ù‚ Ù…Ù„Ù',
        attachedReference: 'ØµÙˆØ±Ø© Ù…Ø±ÙÙ‚Ø©',
        attachedReferences: 'Ø§Ù„ØµÙˆØ± Ø§Ù„Ù…Ø±ÙÙ‚Ø©',
        automationLab: 'Ù…Ø®ØªØ¨Ø± Ø§Ù„Ø£ØªÙ…ØªØ©',
        bleed: 'Ù‡ÙˆØ§Ù…Ø´ Ø·Ø¨Ø§Ø¹Ø©',
        brandArchitect: 'Ù…Ø¹Ù…Ø§Ø± Ø§Ù„Ù‡ÙˆÙŠØ©',
        campaignEngine: 'Ù…Ø­Ø±Ùƒ Ø§Ù„Ø­Ù…Ù„Ø§Øª',
        campaignSignals: 'Ø¥Ø´Ø§Ø±Ø§Øª Ø­Ù…Ù„Ø©',
        catalog: 'Ù…Ù†ØªØ¬Ø§Øª Ø§Ù„ÙƒØªØ§Ù„ÙˆØ¬',
        catalogItems: 'Ù…Ù†ØªØ¬Ø§Øª',
        clearerPrompt: 'Ø§ÙƒØªØ¨ ÙˆØµÙØ§ Ø£ÙˆØ¶Ø­ Ù„Ù„ØªØµÙ…ÙŠÙ….',
        commandTitle: 'ØµÙ…Ù‘Ù…ØŒ Ø­Ù„Ù‘Ù„ØŒ ÙˆÙ†Ø¸Ù‘Ù… Ù…Ù† Ø£Ù…Ø± ÙˆØ§Ø­Ø¯.',
        comparisonWall: 'Ø¬Ø¯Ø§Ø± Ø§Ù„Ù…Ù‚Ø§Ø±Ù†Ø©',
        contextTitle: 'Ù„ÙˆØ­Ø© Ø§Ù„Ø³ÙŠØ§Ù‚',
        creating: 'Ø³ÙˆÙ‚ÙŠ ÙŠØµÙ…Ù… Ø§Ù„Ø£ØµÙ„...',
        collapse: 'Ø·ÙŠ',
        creativity: 'Ù‚ÙˆØ© Ø§Ù„Ø¥Ø¨Ø¯Ø§Ø¹',
        download: 'ØªØ­Ù…ÙŠÙ„',
        eyebrow: '',
        ...
        expand: 'ØªÙˆØ³ÙŠØ¹',
        focus: 'ØªØ±ÙƒÙŠØ²',
        founderFocusBody: 'ØªØ®Ù Ø§Ù„Ø¥Ø¶Ø§Ø¡Ø© ÙˆØªØ®ØªÙÙŠ Ø§Ù„Ù„ÙˆØ­Ø§Øª Ø§Ù„Ø«Ø§Ù†ÙˆÙŠØ© Ø­ØªÙ‰ ÙŠØ¨Ù‚Ù‰ Ø§Ù„Ø£Ù…Ø± Ø§Ù„Ø¥Ø¨Ø¯Ø§Ø¹ÙŠ ÙÙŠ Ø§Ù„Ù…Ù†ØªØµÙ.',
        founderFocusTitle: 'Ù…Ø³Ø§Ø­Ø© Ù‡Ø§Ø¯Ø¦Ø© Ù„Ù„Ø¹Ù…Ù„ Ø§Ù„Ø¹Ù…ÙŠÙ‚.',
        founderMode: 'ÙˆØ¶Ø¹ Ø§Ù„Ù…Ø¤Ø³Ø³',
        generateAutomation: 'ØªÙˆÙ„ÙŠØ¯ ØªØ¯ÙÙ‚ Ø°ÙƒÙŠ',
        generateShort: 'Ø¥Ù†Ø´Ø§Ø¡',
        generatedOutput: 'Ø§Ù„Ù…Ø®Ø±Ø¬ Ø§Ù„Ù†Ø§ØªØ¬',
        growthOpportunity: 'ÙØ±ØµØ© Ù†Ù…Ùˆ',
        headquarters: 'Ø§Ù„Ù…Ù‚Ø± Ø§Ù„Ø¥Ø¨Ø¯Ø§Ø¹ÙŠ',
        heroBody: 'Ø§ÙƒØªØ¨ Ø·Ù„Ø¨Ùƒ Ø¨Ø§Ù„Ø£Ø³ÙÙ„ Ù„Ø¨Ø¯Ø¡ Ø§Ù„Ø¥Ù†Ø´Ø§Ø¡',
        heroTitle: 'Ø¬Ø§Ù‡Ø² Ù„Ù„Ø¥Ù†Ø´Ø§Ø¡',
        high: 'Ø¹Ø§Ù„ÙŠØ©',
        infinityCanvas: 'Ø§Ù„Ù„ÙˆØ­Ø© Ø§Ù„Ù„Ø§Ù…Ø­Ø¯ÙˆØ¯Ø©',
        instructions: 'ØªØ¹Ù„ÙŠÙ…Ø§Øª Ø§Ù„Ù‡ÙˆÙŠØ©',
        instructionsPlaceholder: 'ÙØ§Ø®Ø±ØŒ Ù‡Ø§Ø¯Ø¦ØŒ Ù…Ù†Ø§Ø³Ø¨ Ù„Ù„Ø¹Ø±Ø¨ÙŠØ©ØŒ Ø¥Ø¶Ø§Ø¡Ø© Ø¯Ø§ÙØ¦Ø©...',
        libraryError: 'ØªØ¹Ø°Ø± ØªØ­Ù…ÙŠÙ„ Ù…ÙƒØªØ¨Ø© Ø³ÙˆÙ‚ÙŠ.',
        live: 'Ø­ÙŠ',
        liveModule: 'ÙˆØ­Ø¯Ø© Ø­ÙŠØ©',
        locked: 'Ù…Ù‚ÙÙ„',
        modules: 'ÙˆØ­Ø¯Ø§Øª Ø³ÙˆÙ‚ÙŠ',
        motionBody: 'ØªØ­ÙˆÙŠÙ„ Ø§Ù„Ø¥Ø®Ø±Ø§Ø¬ Ø§Ù„Ø­Ø§Ù„ÙŠ Ø¥Ù„Ù‰ Ø±ÙŠÙ„ Ø£Ùˆ Ø¥Ø¹Ù„Ø§Ù† Ù…ØªØ­Ø±Ùƒ Ø³ÙŠØªÙ… ÙˆØµÙ„Ù‡ Ø¨Ù…Ø­Ø±Ùƒ Ø§Ù„ÙÙŠØ¯ÙŠÙˆ Ù„Ø§Ø­Ù‚Ø§.',
        motionStoryboard: 'Ù„ÙˆØ­Ø© Ø­Ø±ÙƒØ© Ø³ÙŠÙ†Ù…Ø§Ø¦ÙŠØ©',
        motionStudio: 'Ø§Ø³ØªÙˆØ¯ÙŠÙˆ Ø§Ù„Ø­Ø±ÙƒØ©',
        model: 'Ø§Ù„Ù†Ù…ÙˆØ°Ø¬',
        noAssets: 'Ø³ØªØ¸Ù‡Ø± Ø£Ø¹Ù…Ø§Ù„Ùƒ Ø§Ù„Ø£Ø®ÙŠØ±Ø© Ù‡Ù†Ø§.',
        noProducts: 'Ù„Ø§ ØªÙˆØ¬Ø¯ Ù…Ù†ØªØ¬Ø§Øª Ù…Ø±ØªØ¨Ø·Ø© Ø¨Ø¹Ø¯.',
        noSelection: 'Ø§Ø®ØªØ± Ø£ØµÙ„Ø§ Ù…Ù† Ø§Ù„Ù„ÙˆØ­Ø©.',
        noStorefront: 'Ø¨Ø¯ÙˆÙ† Ù…ØªØ¬Ø± Ù…Ø­Ø¯Ø¯',
        openModules: 'ÙØªØ­ Ø§Ù„ÙˆØ­Ø¯Ø§Øª',
        openImage: 'ÙØªØ­ Ø§Ù„ØµÙˆØ±Ø©',
        operatingStudio: 'Luxury AI operating studio',
        outputs: 'Ù…Ø®Ø±Ø¬Ø§Øª',
        preview: 'Ù…Ø¹Ø§ÙŠÙ†Ø©',
        previewModule: 'ÙˆØ­Ø¯Ø© Ù…Ø¹Ø§ÙŠÙ†Ø©',
        preparing: 'Ù†Ø¬Ù‡Ø² Ù…ÙƒØªØ¨Ø© Ø§Ù„Ø£ØµÙˆÙ„...',
        pricingSignal: 'Ø¥Ø´Ø§Ø±Ø© Ø³Ø¹Ø±',
        promptPlaceholder: 'Ø§ÙƒØªØ¨ Ù…Ø§ ØªØ±ÙŠØ¯ Ù…Ù† Ø³ÙˆÙ‚ÙŠ Ø£Ù† ÙŠØµÙ…Ù…Ù‡ Ù„Ù‡Ø°Ø§ Ø§Ù„Ø¨Ø±Ø§Ù†Ø¯...',
        quality: 'Ø§Ù„Ø¯Ù‚Ø©',
        recommendationOne: 'Ø­ÙˆÙ‘Ù„ Ø¢Ø®Ø± ØªØµÙ…ÙŠÙ… Ø¥Ù„Ù‰ Ø­Ù…Ù„Ø© ÙˆØ§ØªØ³Ø§Ø¨ ÙˆØ¥Ù†Ø³ØªØºØ±Ø§Ù….',
        recommendationTwo: 'Ø¬Ø±Ù‘Ø¨ Ø¨Ø·Ø§Ù‚Ø© Ù…Ù†ØªØ¬ Ù…Ø±Ø¨Ø¹Ø© Ù„Ù„Ø¹Ø±ÙˆØ¶ Ø§Ù„Ø³Ø±ÙŠØ¹Ø©.',
        referenceModelUnsupported: 'Ù‡Ø°Ø§ Ø§Ù„Ù†Ù…ÙˆØ°Ø¬ Ù„Ø§ ÙŠØ¯Ø¹Ù… ØªØ¹Ø¯ÙŠÙ„ Ø§Ù„ØµÙˆØ± Ø§Ù„Ù…Ø±Ø¬Ø¹ÙŠØ© ÙÙŠ Ù‡Ø°Ø§ Ø§Ù„Ù…Ø³Ø§Ø±.',
        recentOutputs: 'Ø§Ù„Ù…Ø®Ø±Ø¬Ø§Øª Ø§Ù„Ø£Ø®ÙŠØ±Ø©',
        removeReference: 'Ø¥Ø²Ø§Ù„Ø© Ø§Ù„Ù…Ø±Ø¬Ø¹',
        selected: 'Ø§Ù„Ø£ØµÙ„ Ø§Ù„Ù…Ø­Ø¯Ø¯',
        size: 'Ø§Ù„Ù…Ù‚Ø§Ø³',
        slogan: 'Ø¥Ø·Ù„Ø§Ù‚Ùƒ Ø§Ù„Ù‚Ø§Ø¯Ù… ÙŠØ¨Ø¯Ø£ Ø¨Ù‡ÙˆÙŠØ© Ù„Ø§ ØªØ´Ø¨Ù‡ Ø§Ù„Ø³ÙˆÙ‚.',
        standard: 'Ù‚ÙŠØ§Ø³ÙŠØ©',
        statusIdle: 'Ø¬Ø§Ù‡Ø² Ù„Ø§Ø³ØªÙ‚Ø¨Ø§Ù„ Ø§Ù„Ø£Ù…Ø± Ø§Ù„ØªØ§Ù„ÙŠ.',
        storefront: 'Ø§Ù„Ù…ØªØ¬Ø±',
        storefronts: 'Ù…ØªØ§Ø¬Ø±',
        storeIntelligence: 'Ø°ÙƒØ§Ø¡ Ø§Ù„Ù…ØªØ¬Ø±',
