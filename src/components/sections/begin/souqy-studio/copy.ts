...
export function studioCopy(isRtl: boolean) {
  return isRtl
    ? {
        ...
        model: 'النموذج',
        ideAccept: 'قبول',
        ideAcceptedHint: 'طُبّق التعديل على المستند — احفظ لتثبيته.',
        ideAsk: 'اسأل',
        ideAskFailed: 'تعذر على سوقي اقتراح تعديل.',
        ideAsking: 'سوقي يعدّل...',
        ideBusyBuilding: 'بناء',
        ideBusyLoading: 'تحميل',
        ideBusyManaging: 'معالجة',
        ideBusyThinking: 'تفكير',
        ideAskPlaceholder: 'اطلب من سوقي تعديل هذا المكون...',
        ideComponents: 'المكونات',
        ideDraftPreview: 'المسودة',
        ideLivePreview: 'الموقع الحي',
        ideProposalTitle: 'تعديل سوقي المقترح',
        ideReject: 'رفض',
        ideTransformed: 'اكتمل التحويل — هذا موقعك الجديد.',
        ideTransforming: 'سوقي يحوّل متجرك...',
        ideTransformPlaceholder: 'صف الموقع الذي تريده — سوقي يحوّل المتجر بالكامل...',
        ideInvalidJson: 'صيغة JSON غير صالحة',
        ideLoadFailed: 'تعذر تحميل مكونات المتجر.',
        ideNoBlocks: 'لا توجد مكونات في هذه الصفحة.',
        idePage: 'الصفحة',
        ideSave: 'حفظ',
        ideSaved: 'تم الحفظ — المعاينة تتحدث.',
        ideSaveFailed: 'تعذر حفظ المسودة.',
        ideSaving: 'نحفظ...',
        ideUnsaved: 'تغييرات غير محفوظة',
        modeHints: {
          ...
          code: 'تحرير مكونات المتجر بالكود',
    ...
    : {
        ...
        model: 'Model',
        ideAccept: 'Accept',
        ideAcceptedHint: 'Applied to the document — Save to persist.',
        ideAsk: 'Ask',
        ideAskFailed: 'Souqy could not propose an edit.',
        ideAsking: 'Souqy is editing...',
        ideBusyBuilding: 'Building',
        ideBusyLoading: 'Loading',
        ideBusyManaging: 'Managing',
        ideBusyThinking: 'Thinking',
        ideAskPlaceholder: 'Ask Souqy to change this component...',
        ideComponents: 'Components',
        ideDraftPreview: 'Draft',
        ideLivePreview: 'Live site',
        ideProposalTitle: 'Souqy proposed edit',
        ideReject: 'Reject',
        ideTransformed: 'Transform complete — this is your new website.',
        ideTransforming: 'Souqy is transforming your storefront...',
        ideTransformPlaceholder:
          'Describe the website you want — Souqy transforms the whole storefront...',
        ideInvalidJson: 'Invalid JSON',
        ideLoadFailed: 'Could not load storefront components.',
        ideNoBlocks: 'No components on this page.',
        idePage: 'Page',
        ideSave: 'Save',
        ideSaved: 'Saved — preview refreshing.',
        ideSaveFailed: 'Could not save the draft.',
        ideSaving: 'Saving...',
        ideUnsaved: 'Unsaved changes',
        modeHints: {
          ...
          code: 'Edit storefront components as code',
