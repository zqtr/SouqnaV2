...
const planCopy = {
  ...
  ar: {
    ...
    muted:
      'كل الباقات تشمل واجهات ثنائية اللغة، صفحات مستضافة، محرر الواجهة، وسير عمل مناسب لتجارة الخليج.',
    plans: [
      {
        name: 'مجاني',
        price: 'مجاني',
              ...
              >
                ...
                {featured ? (
                  ...
                  >
                    ...
                    >
                      {pendingPlan === plan.billingPlan
                        ? isRtl
                          ? 'جارٍ التحويل...'
                          : 'Redirecting...'
                        : renderPlanText(plan.cta, isRtl)}
                    </PlanButton>
                  </MetalFrame>
                ) : (
                  <PlanButton
