...
export function BillingTab() {
  return (
    <ComingSoonCard
      ...
      intro={
        <>
          Every storefront can use Free, Pro, Pro+, or Max+. Paid tiers unlock growth tools, richer
          operations, and higher operating limits.
        </>
      }
      bullets={[
        {
        ...
        },
        {
          ...
          detail:
            'SkipCash checkout for online buyer payments, with offline methods tracked on orders.',
        },
        {
          title: 'Invoices & receipts',
          detail: 'Auto-generated PDF invoices in English and Arabic, downloadable per period.',
        },
        {
          title: 'Payment methods',
          detail: 'Update card, change billing email, or pause a storefront without deleting it.',
        },
        {
          title: 'Usage caps',
          detail:
